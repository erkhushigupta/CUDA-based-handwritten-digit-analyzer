...
{
    if(if_train)
        mnist_load("dataset/train-images-idx3-ubyte/train-images.idx3-ubyte", "dataset/train-labels-idx1-ubyte/train-labels.idx1-ubyte",
            &train_set, &train_cnt);
    else 
        mnist_load("dataset/t10k-images-idx3-ubyte/t10k-images.idx3-ubyte", "dataset/t10k-labels-idx1-ubyte/t10k-labels.idx1-ubyte",
            &test_set, &test_cnt);
}
